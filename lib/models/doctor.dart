...
List<Doctor> doctors=[ Doctor("1","Matheus Ferrero","eye specialist","miam,Alexadria",4.9,"Diatrias persuadere, tanquam grandis detrius.Vae.Rusticus, barbatus habitios unus anhelare de alter, secundus brodium.","assets/images/1.jpg"
  ...
  Doctor("4","Diding Sulidinger","eye specialist","miam,Alexadria",4.5,"Diatrias persuadere, tanquam grandis detrius.Vae.Rusticus, barbatus habitios unus anhelare de alter, secundus brodium.",  "assets/images/4.jpg"),
  Doctor("5","Cucup joentravo","eye specialist","miam,Alexadria",4.7,"Diatrias persuadere, tanquam grandis detrius.Vae.Rusticus, barbatus habitios unus anhelare de alter, secundus brodium.",  "assets/images/5.jpg")
];